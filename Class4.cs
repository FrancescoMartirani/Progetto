...
var fileHelper = new Helper(@"C:\Users\student\Desktop\File1.csv");
...
foreach (var prodotto in prod)
{
    Console.WriteLine($"idprodotto: {idprodotto.nome} - nomeprodotto: {prodotto.nomeprodotto} - quantità: {prodotto.quantità}");
}
